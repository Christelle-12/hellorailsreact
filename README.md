...
```sh
  cd my-folder
  git clone https://github.com/Christelle-12/hellorailsreact.git
```
...
Feel free to check the [issues page](https://github.com/Christelle-12/hellorailsreact/issues).
...
- I would like to thank Microverse for providing this great opportunity and for the project guide as well 👏
